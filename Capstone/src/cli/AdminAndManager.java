...
public class AdminAndManager {
	...
	static Connection con;
        static Location n1 = new Location();
	...
	public void adminScreen(){
	    ...
	    switch(input){
	    	...
	    	case 11: {
                ...
                break;
	    	case 12:{
	    		System.out.println("Sorry not an option choose another");
                        adminScreen();
                }
                default:
             System.out.println("Sorry not an option please choose another");
             adminScreen();
	...
	public void addCardScreen(){
		...
		aam.adminScreen();
                     ...
                     System.out.println("Error Please enter a correct month in numeric form: ");
                     }
         }
            catch(InputMismatchException e3){
                     System.out.println("Error Please enter a correct placed date: ");
                     }
       }
	...
	public static void addItemScreen(){
		...
		String vege = sc.next();
               while(!vege.equals('y')|| !vege.equals('n')){
                    System.out.println("\n please enter a valid (y or n) for vegetarian option: ");
                    vege=sc.next();
                    break;
               }
	...
	public static void deleteItemScreen(){
	    ...
	    System.out.println("Deleted " + menus.get(input-1).getName());
            AdminAndManager aaam = new AdminAndManager(con);
            aaam.adminScreen();
	}
  ...
  Scanner sc = new Scanner(System.in);
        String input = sc.next();
             ...
             n1.setTaxRate(taxrate);
             sc.nextLine();
             System.out.println("");
             ls.update(n1);   
             System.out.println("The new address is updated as:\n" + n1.getStreet() + "\n" + n1.getCity() + ", " + n1.getState() + " " + n1.getZip() + "\n" + n1.getCountry());
             System.out.println("");
             System.out.println("Would you like to update another address?(yes/no");
		...
		aam.adminScreen();
                     ...
                     System.out.println("Please enter a correct tip value: ");
                    aam.addOrderScreen();
                     }
             }
                       catch(InputMismatchException e2){
                     System.out.println("Please enter a correct total price: ");
                      aam.addOrderScreen();
                       }
         }
            catch(InputMismatchException e3){
                     System.out.println("Please enter a correct placed timestamp: ");
               aam.addOrderScreen();         
            }
       }
             catch(InputMismatchException e3){
                     System.out.println("Please enter a correct delivery time stamp: ");
               aam.addOrderScreen();
             }
